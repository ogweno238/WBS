...
<div class="container">
<div id="wrapper">
  <h1><center><b>Blue Diamond’s Online Water Billing System</b></center></h1>
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="clients.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Tenants</a></li>
  </ul>
<hr color="#999999" />
  ...
  <!-------------------------- modal ends ---------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"> + Add Tenants</button>
